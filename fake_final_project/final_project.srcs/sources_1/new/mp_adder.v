...
module mp_adder #(
    ...
    // Use our improved parameterized carry lookahead adder
    carry_lookahead_adder_Nb #(.ADDER_WIDTH(ADDER_WIDTH)) 
    cla_inst (
        .iA(operandA), 
        .iB(operandB),
        .iCarry(carry_in),
    ...
    // This shift register should place the adder output at the MSB ADDER_WIDTH-bits,
    ...
    assign operandA = regA_Q[ADDER_WIDTH-1:0];
    assign operandB = regB_Q[ADDER_WIDTH-1:0];
